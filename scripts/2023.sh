...
jkr create_dvv_kohteet 28.1.2023
...
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2023-03-31');"
...
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2023-06-30');"
...
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2023-09-30');"
...
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2023-12-31');"
