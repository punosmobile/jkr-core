...
# DVV-aineisto 2023
log_exec "ogr2ogr -f PostgreSQL -overwrite -progress PG:\"host=$HOST port=$PORT dbname=$DB_NAME user=$USER password=$JKR_PASSWORD ACTIVE_SCHEMA=jkr_dvv\" -nln rakennus ../data/DVV/DVV-aineisto_2023.xlsx \"R1 rakennus\"" \
        "logs/import_dvv_rakennukset.log" \
        "DVV rakennusten tuonti"

log_exec "ogr2ogr -f PostgreSQL -overwrite -progress PG:\"host=$HOST port=$PORT dbname=$DB_NAME user=$USER password=$JKR_PASSWORD ACTIVE_SCHEMA=jkr_dvv\" -nln osoite ../data/DVV/DVV-aineisto_2023.xlsx \"R3 osoite\"" \
        "logs/import_dvv_osoitteet.log" \
        "DVV osoitteiden tuonti"

log_exec "ogr2ogr -f PostgreSQL -overwrite -progress PG:\"host=$HOST port=$PORT dbname=$DB_NAME user=$USER password=$JKR_PASSWORD ACTIVE_SCHEMA=jkr_dvv\" -nln omistaja ../data/DVV/DVV-aineisto_2023.xlsx \"R4 omistaja\"" \
        "logs/import_dvv_omistajat.log" \
        "DVV omistajien tuonti"

log_exec "ogr2ogr -f PostgreSQL -overwrite -progress PG:\"host=$HOST port=$PORT dbname=$DB_NAME user=$USER password=$JKR_PASSWORD ACTIVE_SCHEMA=jkr_dvv\" -nln vanhin ../data/DVV/DVV-aineisto_2023.xlsx \"R9 huon asukk\"" \
...
# Q1 2023 tietojen tuonti
quarter="Q1"
log_exec "jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Paatokset_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/paatokset.log" \
        "Q1 päätösten tuonti"

log_exec "jkr import_ilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Kompostointi-ilmoitus_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/ilmoitukset.log" \
        "Q1 ilmoitusten tuonti"

log_exec "jkr import_lopetusilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Kompostoinnin_lopettaminen_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/lopetusilmoitukset.log" \
        "Q1 lopetusilmoitusten tuonti"

log_exec "jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2023/$quarter LSJ 1.1.2023 31.3.2023" \
        "logs/tietovirrat/2023_$quarter/kuljetukset.log" \
        "Q1 kuljetustietojen tuonti"

log_exec "psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c \"select jkr.tallenna_velvoite_status('2023-03-31');\"" \
        "logs/tietovirrat/2023_$quarter/velvoitteet.log" \
        "Q1 velvoitteiden tallennus"

# Q2 2023 tietojen tuonti
quarter="Q2"
log_exec "jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Paatokset_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/paatokset.log" \
        "Q2 päätösten tuonti"
...
log_exec "jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2023/$quarter LSJ 1.4.2023 30.6.2023" \
        "logs/tietovirrat/2023_$quarter/kuljetukset.log" \
        "Q2 kuljetustietojen tuonti"

log_exec "psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c \"select jkr.tallenna_velvoite_status('2023-06-30');\"" \
        "logs/tietovirrat/2023_$quarter/velvoitteet.log" \
        "Q2 velvoitteiden tallennus"

# Q3 2023 tietojen tuonti
quarter="Q3"
log_exec "jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Paatokset_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/paatokset.log" \
        "Q3 päätösten tuonti"
...
log_exec "jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2023/$quarter LSJ 1.7.2023 30.9.2023" \
        "logs/tietovirrat/2023_$quarter/kuljetukset.log" \
        "Q3 kuljetustietojen tuonti"

log_exec "psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c \"select jkr.tallenna_velvoite_status('2023-09-30');\"" \
        "logs/tietovirrat/2023_$quarter/velvoitteet.log" \
        "Q3 velvoitteiden tallennus"

# Q4 2023 tietojen tuonti
quarter="Q4"
log_exec "jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2023/$quarter/Paatokset_2023$quarter.xlsx" \
        "logs/tietovirrat/2023_$quarter/paatokset.log" \
        "Q4 päätösten tuonti"
...
log_exec "jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2023/$quarter LSJ 1.10.2023 31.12.2023" \
        "logs/tietovirrat/2023_$quarter/kuljetukset.log" \
