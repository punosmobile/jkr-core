...
echo "Tuodaan päätökset ja ilmoitukset 2022..."
# Päätökset ja ilmoitukset Q1 2022
...
# Q2 2022
jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q2/Paatokset_2022Q2.xlsx
jkr import_ilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q2/Kompostointi-ilmoitus_2022Q2.xlsx
jkr import_lopetusilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q2/Kompostoinnin_lopettaminen_2022Q2.xlsx
jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2022/Q2 LSJ 1.4.2022 30.6.2022
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2022-06-30');"

# Q3 2022
jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q3/Paatokset_2022Q3.xlsx
jkr import_ilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q3/Kompostointi-ilmoitus_2022Q3.xlsx
jkr import_lopetusilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q3/Kompostoinnin_lopettaminen_2022Q3.xlsx
jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2022/Q3 LSJ 1.7.2022 30.9.2022
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2022-09-30');"

# Q4 2022  
jkr import_paatokset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q4/Paatokset_2022Q4.xlsx
jkr import_ilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q4/Kompostointi-ilmoitus_2022Q4.xlsx
jkr import_lopetusilmoitukset ../data/Ilmoitus-_ja_päätöstiedot/Päätös-_ja_ilmoitustiedot_2022/Q4/Kompostoinnin_lopettaminen_2022Q4.xlsx
jkr import --luo_uudet ../data/Kuljetustiedot/Kuljetustiedot_2022/Q4 LSJ 1.10.2022 31.12.2022
psql -h $HOST -p $PORT -d $DB_NAME -U $USER -c "select jkr.tallenna_velvoite_status('2022-12-31');"