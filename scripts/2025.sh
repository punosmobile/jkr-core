...
if [ -f "../data/Liete/Lietteenpeltolevitys_2025$quarter.xlsx" ]; then
    log_exec "jkr import_liete ../data/Liete/Lietteenpeltolevitys_2025$quarter.xlsx LSJ 1.4.2025 30.6.2025" \
            "logs/tietovirrat/2025_$quarter/liete_peltolevitykset.log" \
            "Q2 2025 LIETE-peltolevityksen tuonti"
fi
...
# Q2 Kaivotiedon lopetukset (jos saatavilla)
if [ -f "../data/Liete/Kaivotiedot_lopetus_2025$quarter.xlsx" ]; then
    log_exec "jkr import_kaivotiedon_lopetukset ../data/Liete/Kaivotiedot_lopetus_2025$quarter.xlsx LSJ" \
            "logs/tietovirrat/2025_$quarter/kaivotiedot_lopetus.log" \
            "Q2 2025 kaivotiedon lopetusten tuonti"
fi

# Q2 Viemarin lopetukset (jos saatavilla)
if [ -f "../data/Liete/Viemariverkosto_lopetus_2025$quarter.xlsx" ]; then
    log_exec "jkr import_lopeta_viemarit ../data/Liete/Viemariverkosto_lopetus_2025$quarter.xlsx" \
            "logs/tietovirrat/2025_$quarter/viemarilopetus.log" \
            "Q2 2025 viemarin lopetusten tuonti"
fi
