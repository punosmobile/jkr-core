"""
Testit viemäritietojen sisäänluvulle.

Testaa:
- Excel-tiedoston parsinta (Viemäritiedosto, ViemäritiedonLopetusTiedosto)
- Datamallit (ViemärittiedotRow, ViemäritiedonLopetusRow)
