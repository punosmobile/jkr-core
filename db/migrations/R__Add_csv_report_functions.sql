...
BEGIN
    ...
    WITH valid_kuljetukset AS (
        SELECT
            k.kohde_id,
            CASE WHEN jt.selite = 'Muovipakkaus' THEN k.loppupvm END AS muovipakkaus,
            CASE WHEN jt.selite = 'Kartonkipakkaus' THEN k.loppupvm END AS kartonkipakkaus,
            CASE WHEN jt.selite = 'Metalli' THEN k.loppupvm END AS metalli,
            CASE WHEN jt.selite = 'Lasipakkaus' THEN k.loppupvm END AS lasipakkaus,
    ...
    aggregated_kuljetukset AS (
        SELECT
            vk.kohde_id,
            MAX(vk.muovipakkaus) AS muovipakkaus,
            MAX(vk.kartonkipakkaus) AS kartonkipakkaus,
            MAX(vk.metalli) AS metalli,
            MAX(vk.lasipakkaus) AS lasipakkaus,
