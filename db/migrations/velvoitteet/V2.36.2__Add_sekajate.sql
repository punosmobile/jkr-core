CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_pidentava_voimassa(date) RETURNS TABLE (kohde_id integer) AS
$$
...
CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_seka_yli_16_vk_pidentava_ei_ok(date) RETURNS TABLE (kohde_id integer) AS
$$
SELECT DISTINCT k.id
FROM
    jkr.kohde k
...
CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_seka_yli_16_vk_ei_bio_pidentava_ok(date) RETURNS TABLE (kohde_id integer) AS 
$$
SELECT DISTINCT k.id
FROM
    jkr.kohde k
...
CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_seka_yli_16_vk_kompostointi_ok_pidentava_ok(date) RETURNS TABLE (kohde_id integer) AS
$$
SELECT DISTINCT k.id
FROM
    jkr.kohde k
