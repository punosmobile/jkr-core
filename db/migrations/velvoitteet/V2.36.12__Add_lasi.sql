CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_lasi_puuttuu(date) RETURNS TABLE (kohde_id integer) AS
$$
...
CREATE OR REPLACE FUNCTION jkr.kohteet_joilla_lasi_enintaan_26_vk(date) RETURNS TABLE (kohde_id integer) AS
$$
SELECT DISTINCT k.id
FROM
    jkr.kohde k
